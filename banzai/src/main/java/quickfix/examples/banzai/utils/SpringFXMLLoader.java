...
public class SpringFXMLLoader<S, T> {
  ...
  private SpringFXMLLoader(ApplicationContext applicationContext, URL location,
      InputStream inputStream, ResourceBundle resources, Charset charset) {
  ...
  public static class Builder {
    ...
    public <S, T> SpringFXMLLoader<S, T> build() {
      ...
      return new SpringFXMLLoader<>(applicationContext, location, inputStream, resources, charset);
    }
